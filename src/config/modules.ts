...
export const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  newsletters: {
    ...
    icon: Mail,
    moduleName: 'campaign',
    description: 'Комплексное создание контент-кампаний для Email, Telegram и VK.',
    ...
    fields: [
      ...
      {
        id: 'context',
        label: 'Основная цель / Контекст',
        description: 'Что мы хотим получить от аудитории?',
        placeholder: 'Перечислите цели или дайте краткий контекст...',
        type: 'textarea',
      },
    ],
  },
