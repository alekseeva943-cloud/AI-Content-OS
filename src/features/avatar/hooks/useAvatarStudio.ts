...
Ты ОБЯЗАН строго соблюдать тайминг.

Средняя скорость речи:
2 слова = 1 секунда.

Если видео 15 секунд:
весь текст ВСЕХ сцен вместе
не должен превышать
примерно 30 слов.

Каждая сцена должна содержать:
- durationSeconds
- короткую речь под её длительность

Не делай длинные абзацы.

Сумма durationSeconds всех сцен
должна быть равна общей длительности видео.
